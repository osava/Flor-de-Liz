    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo $add_link;?>"> Add Filters</a></li>
            ...
            <tbody>
              ...
              <tr id="filter-row<?php echo $filter_row; ?>">
                <td class="text-left" style="width: 70%;"><input type="hidden" name="filter[<?php echo $filter_row; ?>][filter_id]" value="<?php echo $filter['filter_id']; ?>" />
                  ...
                  <?php } ?>
                  <?php } ?></td>
				  <td class="text-left"><a href="" id="thumb-image<?php echo $filter_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo isset($filter['thumb'])?$filter['thumb']:$placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="filter[<?php echo $filter_row; ?>][image]" value="<?php echo isset($filter['image'])?$filter['image']:''; ?>" id="input-image<?php echo $filter_row; ?>" /></td>
...
function addFilterRow() {
	...
	<?php } ?>
	html += '  </td>';
	html += '<td class="text-left"><a href="" id="thumb-image' + filter_row + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title=""" /></a>';
     html += ' <input type="hidden" name="filter[' + filter_row + '][image]" value="" id="input-image' + filter_row + '" /></td>';
