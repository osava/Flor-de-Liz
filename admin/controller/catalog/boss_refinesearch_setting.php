...
class ControllerCatalogBossRefinesearchSetting extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/boss_refinesearch_setting', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/boss_refinesearch_setting', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('catalog/boss_refinesearch_setting/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('catalog/boss_refinesearch_setting/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['filters'][] = array(
				...
				'edit'            => $this->url->link('catalog/boss_refinesearch_setting/edit', 'token=' . $this->session->data['token'] . '&filter_group_id=' . $result['filter_group_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('catalog/boss_refinesearch_setting', 'token=' . $this->session->data['token'] . '&sort=fgd.name' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('catalog/boss_refinesearch_setting', 'token=' . $this->session->data['token'] . '&sort=fg.sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('catalog/boss_refinesearch_setting', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('catalog/boss_refinesearch_setting_list.tpl', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['filter_group_id'])) {
			$data['action'] = $this->url->link('catalog/boss_refinesearch_setting/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('catalog/boss_refinesearch_setting/edit', 'token=' . $this->session->data['token'] . '&filter_group_id=' . $this->request->get['filter_group_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('catalog/boss_refinesearch_setting', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('catalog/boss_refinesearch_setting_form.tpl', $data));
	}
