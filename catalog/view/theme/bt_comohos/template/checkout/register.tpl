...
<div class="buttons clearfix">
  <div class="pull-left"><input type="checkbox" name="agree" value="1" />&nbsp;<?php echo $text_agree; ?> 
	<br/>
    <input type="button" value="<?php echo $button_continue; ?>" id="button-register" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-gray" />
  </div>
</div>
<?php } else { ?>
<div class="buttons clearfix">
